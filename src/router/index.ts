...
import billStateRoutes from './modules/bill-state'
import billRoutes from './modules/bill'
import billDetailRoutes from './modules/bill-detail'
import sliderRoutes from './modules/Sliders'
...
export const asyncRoutes: RouteConfig[] = [
    ...
    children: [
      {
        path: 'page',
        component: () =>
          import(/* webpackChunkName: "pagePermission" */ '@/views/permission/page.vue'),
        name: 'PagePermission',
        meta: {
      ...
      },
      {
        path: 'role',
        component: () =>
          import(/* webpackChunkName: "rolePermission" */ '@/views/permission/role.vue'),
        name: 'RolePermission',
        meta: {
  ...
  //       path: '401',
  //       component: () =>
  //         import(/* webpackChunkName: "page401" */ '@/views/error-page/401.vue'),
  //       name: 'Page401',
  ...
  //       path: '404',
  //       component: () =>
  //         import(/* webpackChunkName: "page404" */ '@/views/error-page/404.vue'),
  //       name: 'Page404',
  ...
  //       path: 'log',
  //       component: () =>
  //         import(/* webpackChunkName: "errorLog" */ '@/views/error-log/index.vue'),
  //       name: 'ErrorLog',
  ...
  //       path: 'export-excel',
  //       component: () =>
  //         import(/* webpackChunkName: "exportExcel" */ '@/views/excel/export-excel.vue'),
  //       name: 'ExportExcel',
  ...
  //       component: () =>
  //         import(/* webpackChunkName: "selectExcel" */ '@/views/excel/select-excel.vue'),
  //       name: 'SelectExcel',
  ...
  //       component: () =>
  //         import(/* webpackChunkName: "mergeHeader" */ '@/views/excel/merge-header.vue'),
  //       name: 'MergeHeader',
  ...
  //       path: 'upload-excel',
  //       component: () =>
  //         import(/* webpackChunkName: "uploadExcel" */ '@/views/excel/upload-excel.vue'),
  //       name: 'UploadExcel',
  ...
  //   path: '/pdf/download',
  //   component: () =>
  //     import(/* webpackChunkName: "pdfDownload" */ '@/views/pdf/download.vue'),
  //   meta: { hidden: true },
  // },
  {
    path: '/theme',
  ...
  //       path: 'index',
  //       component: () =>
  //         import(/* webpackChunkName: "clipboard" */ '@/views/clipboard/index.vue'),
  //       name: 'Clipboard',
  ...
  //       path: 'index',
  //       component: () =>
  //         import(/* webpackChunkName: "i18n" */ '@/views/international/index.vue'),
  //       name: 'I18n',
