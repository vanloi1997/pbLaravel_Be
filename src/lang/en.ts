export default {
  route: {
    ...
    createBillDetail: 'Create Bill Detail',
    editBillDetail: 'Edit Bill Detail',
    billDetailList: 'Bill Detail List',
    slider: 'Slider',
    ...
    createBillState: 'Create Bill State',
    editBillState: 'Edit Bill State',
    billStateList: 'Bill State List',
    bill: 'Bill',
    ...
    product: 'Article',
    createProduct: 'Create Article',
    editProduct: 'Edit Article',
    productList: 'Article List',
